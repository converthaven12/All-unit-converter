...
export const CONVERTERS: Converter[] = [
  ...
  },
  {
    ...
    from: "Millimeters",
    to: "Inches",
    symbols: { from: "mm", to: "in" },
    categoryId: "length",
    factor: 0.0393701,
    topValues: [1, 5, 10, 15, 20, 25, 50, 75, 100, 150, 200, 250, 300, 500, 1000],
  },
  {
    slug: "inches-to-mm",
    from: "Inches",
    to: "Millimeters",
    symbols: { from: "in", to: "mm" },
    categoryId: "length",
    factor: 25.4,
    topValues: [0.5, 1, 2, 3, 4, 5, 6, 10, 12, 15, 18, 24, 30, 36, 48],
  },
